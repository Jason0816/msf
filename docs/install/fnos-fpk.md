...
| 架构 | FPK 资产 |
|---|---|
| x86 / amd64 | `https://github.com/scoltzero/msf/releases/download/v0.4.1/msf_0.4.1_x86.fpk` |
| ARM / arm64 | `https://github.com/scoltzero/msf/releases/download/v0.4.1/msf_0.4.1_arm.fpk` |
