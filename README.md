...
| fnOS x86 FPK | [Latest Release](https://github.com/scoltzero/msf/releases/latest) 中的 `msf_*_x86.fpk` |
| fnOS ARM FPK | [Latest Release](https://github.com/scoltzero/msf/releases/latest) 中的 `msf_*_arm.fpk` |
| Unraid PLG | `https://github.com/scoltzero/msf/releases/latest/download/msf.plg` |
| macOS Universal 2 DMG（未签名 Beta） | [Latest Release](https://github.com/scoltzero/msf/releases/latest) 中的 `MSF-*-macos-universal-unsigned.dmg` |
| macOS Universal 2 ZIP（未签名 Beta） | [Latest Release](https://github.com/scoltzero/msf/releases/latest) 中的 `MSF-*-macos-universal-unsigned.zip` |
